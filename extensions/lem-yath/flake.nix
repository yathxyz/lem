      ...
      perSystem =
        ...
        let
          ...
          gitRebaseTest = pkgs.writeShellApplication {
            ...
            text = ''
              export LEM_BIN=${lemYath}/bin/lem
              export LEMCLIENT_BIN=${lemClient}/bin/lemclient
              exec python3 ${self}/scripts/git-rebase-test.py
            '';
          };
        ...
        rec {
          ...
          checks = {
            ...
            agenda-dispatch = mkCheckWithLem lemYath "agenda-dispatch" "agenda-dispatch-test.sh";
            agenda-query = mkCheckWithLem lemYath "agenda-query" "agenda-query-test.sh";
