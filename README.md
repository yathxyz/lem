...
electric-editing, UI parity, project navigation, project-scoped LSP lifecycle, notes, and
...
`lsp-project`, `project-navigation`, `electric-editing`, `ui-parity`, `interactive`, `structural`, or
